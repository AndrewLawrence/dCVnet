...
dCVnet <- function(
  ...
  # create a sanitised call to multialpha.repeated.cv.glmnet which will be
  #   modified then evaluated within each run of the outer loop.
  ...
  # Notes: x and y are added within inner loop.
  #        inner folds are autogenerated by multialpha.repeated.cv.glmnet
